...
def main():
    ...
    for line in fileinput.input(
        ...
        if "OutputBaseFilename" in line:
            if demo:
                line = "OutputBaseFilename=ModernMetal Demo Installer\n"
            else:
                line = "OutputBaseFilename=ModernMetal Installer\n"
        ...
        if "WelcomeLabel1" in line:
            if demo:
                line = "WelcomeLabel1=Welcome to the ModernMetal Demo installer\n"
            else:
                line = "WelcomeLabel1=Welcome to the ModernMetal installer\n"

        if "SetupWindowTitle" in line:
            if demo:
                line = "SetupWindowTitle=ModernMetal Demo installer\n"
            else:
                line = "SetupWindowTitle=ModernMetal installer\n"
