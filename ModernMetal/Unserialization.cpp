...
void ModernMetal::_UnserializeApplyConfig(nlohmann::json& config)
{
...
int ModernMetal::_UnserializeStateWithKnownVersion(const iplug::IByteChunk& chunk, int startPos)
{
...
int ModernMetal::_UnserializeStateWithUnknownVersion(const iplug::IByteChunk& chunk, int startPos)
{
  nlohmann::json config;
